...
Дальнейшие оптимизации этой хэш-таблицы нецелесообразны: слишком маленький прирост производительности.

Но одна из задач работы - использовать три вида оптимизации, поэтому в учебных целях было проведены следующие ускорения:
...
- хэш-функция `return len(word)` оптимизирована при помощи ассемблерной вставки. Прирост производительности:
